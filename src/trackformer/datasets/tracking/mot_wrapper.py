...
from .bktris_sequence import BKTRISSequence

class BKTRISWrapper(Dataset):
    ...
    def __init__(self, split: str, dets: str, **kwargs) -> None:
        ...
        for seq in sequences:
            self._data.append(BKTRISSequence(seq_name=seq, dets=dets, **kwargs))
